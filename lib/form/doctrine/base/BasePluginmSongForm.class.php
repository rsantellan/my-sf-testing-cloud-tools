...
/**
 * PluginmSong form base class.
 *
 * @method PluginmSong getObject() Returns the current form's model object
 *
 * @package    testing
 * @subpackage form
 ...
 */
abstract class BasePluginmSongForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pluginm_song[%s]');
