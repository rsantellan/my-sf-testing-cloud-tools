...
/**
 * PluginmyCategory filter form base class.
 *
 * @package    testing
 * @subpackage filter
 ...
 */
abstract class BasePluginmyCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pluginmy_category_filters[%s]');
