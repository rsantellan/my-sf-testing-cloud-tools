...
/**
 * PluginmSong filter form base class.
 *
 * @package    testing
 * @subpackage filter
 ...
 */
abstract class BasePluginmSongFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pluginm_song_filters[%s]');
