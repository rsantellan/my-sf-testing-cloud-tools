...
/**
 * PluginmyCategory form base class.
 *
 * @method PluginmyCategory getObject() Returns the current form's model object
 *
 * @package    testing
 * @subpackage form
 ...
 */
abstract class BasePluginmyCategoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'PluginmyCategory', 'column' => array('label')))
    );

    $this->widgetSchema->setNameFormat('pluginmy_category[%s]');
