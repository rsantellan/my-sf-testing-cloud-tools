...
class myVimeo
{
  ...
  {
    self::$OEMBED_ENDPOINT = sfConfig::get('app_vimeo_OEMBED_ENDPOINT', "http://vimeo.com/api/oembed.xml");
    self::$API_ENDPOINT = sfConfig::get('app_vimeo_API_ENDPOINT', "http://vimeo.com/api/v2/");
  }
